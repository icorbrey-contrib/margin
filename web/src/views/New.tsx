        ...
        return (
            <div className="max-w-sm mx-auto py-16 px-4">
                <div className="bg-white dark:bg-surface-900 rounded-xl ring-1 ring-black/5 dark:ring-white/5 p-6 text-center">
                    <h2 className="text-xl font-bold text-surface-900 dark:text-white mb-2">Sign in to create</h2>
                    <p className="text-surface-500 dark:text-surface-400 text-sm mb-5">You need a Bluesky account</p>
                    <Link to="/login" className="block w-full py-2.5 px-4 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors">
    ...
    return (
        <div className="max-w-2xl mx-auto pb-20">
            <div className="mb-6 text-center sm:text-left">
                <h1 className="text-2xl font-display font-bold text-surface-900 dark:text-white mb-1">New Annotation</h1>
                <p className="text-surface-500 dark:text-surface-400">Write in the margins of the web</p>
            </div>

            {!initialUrl && (
                <div className="mb-4">
                    <label htmlFor="url-input" className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1.5">
                        URL to annotate
                    </label>
                    <input
                        id="url-input"
